...
import 'package:lean_flutter/model/response/cutomer_idx_get_res.dart';
            ...
            onSelected: (value) {
              showDialog(
                ...
                builder: (context) => SimpleDialog(
                  ...
                  children: [
                    Text('คุณต้องการลบข้อมูลสมาชิก ใช่หรือไม่?'),
                    Row(
                      ...
                      children: [
                        ...
                        FilledButton(onPressed: delete, child: Text('ตกลง')),
                      ],
                    ),
                  ],
                ),
